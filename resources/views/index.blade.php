        ...
        <div class="flex justify-between">
            ...
            <div class="w-200 h-113 border-solid border-2 border-gray-300 bg-white">
                ...
                <div class="h-101 flex justify-center pt-45 bg-gray-100">
                    <h3 class="text-3xl font-semibold text-gray-500">There's no activity</h3>
                </div>
            </div>
            
            <!-- Metrics -->
            <div class="w-98 h-113 border-solid border-2 border-gray-300 bg-white">
                <h3 class="border-solid border-b-2 border-gray-300 flex justify-center font-semibold text-xl py-4">Quick Metrics</h3>
